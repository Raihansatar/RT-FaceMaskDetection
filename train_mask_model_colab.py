...
model.save("/content/drive/MyDrive/facemask/mask_detectorversionpaliglatest.model", save_format="h5")
...
plt.savefig("/content/drive/MyDrive/facemask/plotpalinglatest.png")